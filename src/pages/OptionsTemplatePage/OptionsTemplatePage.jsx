  ...
  const fetchTopics = async (className, gradeKey) => {
    ...
    try {
      ...
      if (err.message.includes("CORS")) {
        errorMessage =
          "Lỗi CORS: Backend cần cấu hình CORS headers. Liên hệ admin backend.";
        ...
        errorMessage =
          "Lỗi kết nối. Kiểm tra URL backend: https://localhost:7259";
      }
          ...
          <div key={topic.topicID} className="topic-card">
            ...
            <div
              className={`topic-card-header ${
                expandedTopicId === topic.topicID ? "expanded" : ""
              }`}
                  ...
                  <div className="contents-list">
                    {topic.contents.map((content) => (
                      <div key={content.contentID} className="content-item">
                        ...
                        <button
                          className="create-slide-btn"
                          onClick={() => {
                            const templateId = new URLSearchParams(
                              window.location.search
                            ).get("templateId");

                            if (!templateId) {
                              alert("Bạn chưa chọn template.");
                            ...
                            url.searchParams.set("topicId", topic.topicID);
      ...
      <div className="options-template-wrapper">
              ...
              >
                ...
                <div
                  className={`grade-checkbox ${
                    selectedGrade === gradeKey ? "checked" : ""
                  }`}
                >
        ...
        {selectedClass && (
          <div className="topics-section">
            ...
            {!loading && !error && topics.length === 0 && (
              <div className="no-topics">📭 Chưa có chủ đề nào cho lớp này</div>
            )}
          </div>
        )}
        ...
        {selectedGrade && selectedClass && (
          <div className="selection-summary">
            <p>
              Bạn đã chọn: <strong>{gradeOptions[selectedGrade].name}</strong> -{" "}
